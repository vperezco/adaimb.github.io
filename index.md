...
In order to conduct our study of this data set, we used work done by Motoki Masuda and Fumiko Takeda at *Department of Technology Management for Innovation University of Tokyo* and Levent Bulut at *Department of Economics and Finance, Harley Langdale, Jr. College of Business Administration, Valdosta State University, Valdosta, GA 31698, USA* for their respective papers **Application of Google Trends Data in Exchange Rate Prediction** and **Google Trends and the forecasting performance of exchange rate models**.
